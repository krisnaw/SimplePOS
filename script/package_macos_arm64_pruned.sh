...
RELEASE_DIR="$ROOT_DIR/release/mac-arm64-pruned"
...
cp "$ROOT_DIR/package-lock.json" "$APP_PAYLOAD/package-lock.json"

echo "Installing production dependencies"
npm --prefix "$APP_PAYLOAD" ci --omit=dev --ignore-scripts
