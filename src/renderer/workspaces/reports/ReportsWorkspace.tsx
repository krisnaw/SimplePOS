          ...
          <Dialog>
            ...
            <DialogContent className="max-h-[calc(100vh-2rem)] overflow-hidden p-0 sm:max-w-5xl">
              ...
              <div className="min-h-0 overflow-y-auto bg-muted/60 px-4 py-5 sm:px-8">
                <article className="mx-auto flex min-h-[920px] w-full max-w-[720px] flex-col gap-7 rounded-sm bg-white p-8 text-zinc-950 shadow-lg ring-1 ring-black/10 sm:p-10">
                  ...
                  <section className="flex flex-col gap-3">
                    ...
                    <div className="overflow-hidden rounded-md ring-1 ring-zinc-200">
                      <div className="grid grid-cols-[minmax(0,1fr)_70px_110px] gap-3 bg-zinc-100 px-3 py-2 text-[10px] font-medium uppercase tracking-wide text-zinc-500">
                    ...
                    {report.lowStockItems.length === 0 ? (
                      ...
                      <div className="grid gap-2 sm:grid-cols-2">
                        {report.lowStockItems.slice(0, 6).map((item) => (
                          <div key={item.id} className="flex items-center justify-between gap-4 rounded-md bg-zinc-100 px-3 py-2 text-xs">
                            <span className="truncate">{item.name}</span>
                  ...
                  <footer className="mt-auto flex items-center justify-between gap-4 border-t border-zinc-200 pt-4 text-[10px] text-zinc-500">
