...
const guideSections: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Add products and services to Current Sale, then confirm the quantity, subtotal, and total with the customer.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Review subtotal and total in the Current Sale panel.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Use the receipt preview to confirm subtotal, total, and payment amount.',
