...
export function generateReceiptHTML(
  ...
  const businessLogo = businessProfile.companyLogo
    ? `<img class="business-logo" src="${escapeHtml(businessProfile.companyLogo)}" alt="${escapeHtml(businessName)} logo" />`
    : ''
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .business-logo { display: block; width: 92px; height: 56px; object-fit: contain; object-position: left center; }
